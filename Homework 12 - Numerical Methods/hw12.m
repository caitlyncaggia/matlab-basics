...
%
% Function Description:
%   Given a vector of x-values, a vector of corresponding y-values, a
...
%       1) The extrapolation performed using first 1/5th of data.
%       2) The extrapolation performed using first 2/5ths of data.
%       3) The extrapolation performed using first 3/5ths of data.
%       4) The extrapolation performed using first 4/5ths of data.
